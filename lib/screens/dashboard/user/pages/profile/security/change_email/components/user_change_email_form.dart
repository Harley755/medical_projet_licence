...
class UserChangeEmailForm extends StatefulWidget {
  const UserChangeEmailForm({super.key});

  @override
  State<UserChangeEmailForm> createState() => _UserChangeEmailFormState();
}

class _UserChangeEmailFormState extends State<UserChangeEmailForm> {
