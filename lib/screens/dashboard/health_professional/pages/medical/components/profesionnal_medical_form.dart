...
class ProfessionalMedicalForm extends StatefulWidget {
  final GlobalKey<FormState> formKey;

  const ProfessionalMedicalForm({super.key, required this.formKey});

  @override
  State<ProfessionalMedicalForm> createState() =>
      _ProfessionalMedicalFormState();
}

class _ProfessionalMedicalFormState extends State<ProfessionalMedicalForm> {
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          // GROUPE SANGUIN
          buildBloodTypeFormField(bloodTypeItems, selectedValue),
