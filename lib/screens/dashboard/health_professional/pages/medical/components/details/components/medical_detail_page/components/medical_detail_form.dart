...
class MedicalDetailForm extends StatefulWidget {
  final String userId;
  ...
  @override
  State<MedicalDetailForm> createState() => _MedicalDetailFormState();
}

class _MedicalDetailFormState extends State<MedicalDetailForm> {
  ...
  void initState() {
    if (widget.userId != "") {
      _userMedicalFuture =
          UserAuthMethods().getUserMedicalDetails(userId: widget.userId);
